...
if user_menu=="Overall Analysis":
    ...
    # most successful athletes of its repective sports
...
if user_menu=="Country-wise Analysis":
    ...
    top_10_df=helper.most_successful_country(df,selected_country)
    st.table(top_10_df)
...
if user_menu=="Athlete wise Analysis":
    ...
    # age wise winning to any sports
    x = []
    name = []
